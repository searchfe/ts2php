...
declare namespace ts {
    ...
    export interface Node extends TextRange {
        ...
        contextualMapper?: TypeMapper;        // Mapper for contextual type
    }
    ...
    export interface CustomTransformers {
        ...
        afterDeclarations?: (TransformerFactory<SourceFile> | CustomTransformerFactory)[];
    }
...
declare namespace ts {
    ...
    function updateBundle(node: Bundle, sourceFiles: ReadonlyArray<SourceFile | InputFiles>, prepends?: ReadonlyArray<UnparsedSource>): Bundle;
...
declare namespace ts {
    ...
    interface LanguageServiceHost extends GetEffectiveTypeRootsHost {
        ...
        resolveModuleNames?(moduleNames: string[], containingFile: string, reusedNames: string[] | undefined, redirectedReference: ResolvedProjectReference | undefined, options: CompilerOptions): ResolvedModule[];
        getResolvedModuleWithFailedLookupLocationsFromCache?(modulename: string, containingFile: string): ResolvedModuleWithFailedLookupLocations | undefined;
        resolveTypeReferenceDirectives?(typeDirectiveNames: string[], containingFile: string, redirectedReference: ResolvedProjectReference | undefined, options: CompilerOptions): ResolvedTypeReferenceDirective[];
